...
class LivroSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $livro->edicao = 1;
        $livro->volume = 1;
        $livro->foto = "storage/profile_photos/4111.jpg";
        ...
        $livro->edicao = 1;
        $livro->volume = 1;
        $livro->foto = "storage/profile_photos/4122.jpg";
        ...
        $livro->edicao = 1;
        $livro->volume = 1;
        $livro->foto = "storage/profile_photos/4133.jpg";
        ...
        $livro->edicao = 1;
        $livro->volume = 1;
        $livro->foto = "storage/profile_photos/4144.jpg";
