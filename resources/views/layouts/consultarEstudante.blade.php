        ...
        <div class="modal fade" id="modal-alterar-permissao" tabindex="-1" role="dialog" aria-labelledby="modal-alterar-permissao" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form id="alterar-permissao-form" class="col-md-12 cadastro" action={{ route('auth.on.estudante.deletar') }} method="POST">
                        @csrf
                        <div class="modal-body">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <p>Deseja realmente excluir o registro do(a) estudante @if(isset($estudante)){{$estudante->nome}}@endif ?</p>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn operacao-btn">Excluir</button>
                        </div>
                    </form>
                </div>
            </div>
